...
public class LinkedDeque<E> implements Deque<E> {
    ...
    public void addFirst(E element) {
        size += 1;
        Node<E> firstNode = new Node<>(element, front, front.next);
        front.next.prev = firstNode;
    ...
    public void addLast(E element) {
        size += 1;
        Node<E> lastNode = new Node<>(element, back.prev, back);
        back.prev.next = lastNode;
        back.prev = lastNode;
    }
